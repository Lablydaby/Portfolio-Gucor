...
`;
    ...
    class WebGLManager {
      ...
      loop() {
        ...
        this.render();
        rafRef.current = requestAnimationFrame(this._loop) as unknown as number;
      }
    ...
    const io = new IntersectionObserver(
      entries => {
        ...
        // Only pause if completely out of view (not intersecting at all) or document is hidden
